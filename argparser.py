...
def initialize_argparse() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        '--target_ip',
        help='IP address of destination computer. Provide this along with --target_port to act \
              as the connecting device.'
    )

    parser.add_argument(
        '--target_port',
        help='Port number of destination computer. Provide this along with --target_ip to act \
              as the connecting device.',
        type=int
    )
